...
def main():
    ...
    for digit in traindata:
        split_traindata.append(data_split(digit, num_split * 2))
    ...
    for digit in testdata:
        split_testdata.append(data_split(digit, num_split * 2))
    ...
    train_path = '{}/data/train/all_data_{}_niid.pkl'.format(os.path.join(cpath, options['dataset']), image)
    test_path = '{}/data/test/all_data_{}_niid.pkl'.format(os.path.join(cpath, options['dataset']), image)
